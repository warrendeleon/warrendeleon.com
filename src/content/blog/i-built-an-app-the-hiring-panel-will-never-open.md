...
I designed the scorecards for our React Native hiring process [earlier this year](/blog/how-i-designed-a-tech-test-scorecard-that-works-from-graduate-to-senior/). Three assessments: a **100-check code review**, a **walkthrough interview** scored 1–5, and a **behavioural interview** mapped to our five values. The scoring worked. The format I was using to capture those scores during a live call did not.
...
**Notion** was my first thought. I use it for everything personal. But it's not a tool we use at work. Building on a platform I'd be the only one using felt like a dead end, so I dropped it before starting.
