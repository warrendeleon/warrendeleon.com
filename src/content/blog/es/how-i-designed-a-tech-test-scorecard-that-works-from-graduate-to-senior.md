...
Cuando empecé a armar el proceso de contratación para mi squad, sabía que quería un scorecard estructurado desde el primer día. Escribí sobre la prueba técnica en sí en [un post anterior](/blog/why-i-redesigned-our-react-native-tech-test-in-my-first-week/). La prueba funcionaba. La puntuación, no. Al menos, no como la diseñé al principio.
...
Usé este scorecard para nuestra primera ronda de contratación de React Native. Mi par EM lo revisó y lo adoptó para las contrataciones de su squad también. Esa es la prueba de un buen sistema: **alguien más puede agarrarlo y usarlo sin que estés en la sala.**
