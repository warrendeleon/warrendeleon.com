...
He fet servir aquest scorecard per a la nostra primera ronda de contractació de React Native a HL. El meu company EM el va revisar i el va adoptar per a les contractacions del seu squad també. Aquesta és la prova d'un bon sistema: **algú altre pot agafar-lo i fer-lo servir sense que tu siguis a la sala.**
